...
const ProfilePage = () => {
  ...
  return (
    <>
      <div className="relative max-w-2xl mx-auto z-1000 mb-0  bg-white rounded-lg shadow-md ">
        <div className="max-w-2xl mx-auto">
          {/* Cover */}
          <div className="z-1000 bg-white  h-40 relative">
          ...
          {/* Profile */}
          <div className=" z-1000 absolute top-28 m-3 flex gap-5 items-center">
            <img
              src={profile_image || ""}
              alt="profile"
